...
// Set a new value:
async function transferNFT(tokenID, addressTo) {
    const transaction = await contract.transferNFT(tokenID, addressTo);
  ...
  (async () => {
    ...
    const tokenID = 0;
    const addressTo = '0xfd5a57c44ccf2e676fc45705dc2d17d2f070e528';
    await transferNFT(tokenID,addressTo);
