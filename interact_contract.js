...
const contractAddress = '0xb9532f59621a8d8fc5e33f4695301fbd8fcfe23d';
const contractAbi = [
    {
      "inputs": [],
...
// Set a new value:
async function mintNFT(addressTo) {
    const transaction = await contract.mintNFT(addressTo);
  ...
  (async () => {
    ...
    const addressTo = '0xafb70bdcfecfe4a2f4ab6112500db934fd74fdc7';
    await mintNFT(addressTo);
